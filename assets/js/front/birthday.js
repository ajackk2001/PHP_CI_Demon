        ...
        ms_DatePicker: function(options) {
            ...
            function ms_DatePicker($container) {
                ...
                function buildYear(selectedYear) {
                    ...
                    $year.html($(`<option disabled>年</option>`).prop("selected", !Boolean(selectedYear)));
                ...
                function buildMonth(selectedMonth) {
                    $month.html($(`<option disabled>月</option>`).prop("selected", !Boolean(selectedMonth)));
                    for (var i = 1; i <= 12; ++i) {
                ...
                function buildDay(selectedDay) {
                    ...
                    $day.html($(`<option disabled>日</option>`).prop("selected", !Boolean(selectedDay)));
