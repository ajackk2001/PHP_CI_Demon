...
class Google_Service_ServiceUsage_Resource_Operations extends Google_Service_Resource
{
   ...
   * @param Google_Service_ServiceUsage_CancelOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_ServiceUsage_ServiceusageEmpty
   */
  public function cancel($name, Google_Service_ServiceUsage_CancelOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Google_Service_ServiceUsage_ServiceusageEmpty");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_ServiceUsage_ServiceusageEmpty");
  }
  /**
