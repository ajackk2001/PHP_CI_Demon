...
class Google_Service_Vision_GoogleCloudVisionV1p3beta1Word extends Google_Collection
{
  ...
  protected $symbolsType = 'Google_Service_Vision_GoogleCloudVisionV1p3beta1Symbol';
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1p3beta1Symbol
   */
