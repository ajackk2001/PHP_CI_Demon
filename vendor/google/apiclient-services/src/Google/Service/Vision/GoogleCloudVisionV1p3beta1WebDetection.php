...
class Google_Service_Vision_GoogleCloudVisionV1p3beta1WebDetection extends Google_Collection
{
  protected $collection_key = 'webEntities';
  protected $bestGuessLabelsType = 'Google_Service_Vision_GoogleCloudVisionV1p3beta1WebDetectionWebLabel';
  ...
  protected $pagesWithMatchingImagesType = 'Google_Service_Vision_GoogleCloudVisionV1p3beta1WebDetectionWebPage';
  ...
  protected $visuallySimilarImagesType = 'Google_Service_Vision_GoogleCloudVisionV1p3beta1WebDetectionWebImage';
  protected $visuallySimilarImagesDataType = 'array';
  protected $webEntitiesType = 'Google_Service_Vision_GoogleCloudVisionV1p3beta1WebDetectionWebEntity';
