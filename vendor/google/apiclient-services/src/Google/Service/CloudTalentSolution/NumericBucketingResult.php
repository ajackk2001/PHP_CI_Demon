...
class Google_Service_CloudTalentSolution_NumericBucketingResult extends Google_Collection
{
  protected $collection_key = 'counts';
  protected $countsType = 'Google_Service_CloudTalentSolution_BucketizedCount';
