...
class Google_Service_Digitalassetlinks_Resource_Statements extends Google_Service_Resource
{
   ...
   * `https://`), this guarantee cannot be made.
   *
   * The `List` command is most useful in cases where the API client wants to know
   * all the ways in which two assets are related, or enumerate all the
   ...
   * Google+ profile. (statements.listStatements)
   *
   ...
   * or *    the query's relation string is empty or missing.
   *
