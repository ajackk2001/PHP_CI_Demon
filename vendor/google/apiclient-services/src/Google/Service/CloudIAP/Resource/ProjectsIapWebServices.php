 ...
 *   $services = $iapService->services;
 *  </code>
 */
class Google_Service_CloudIAP_Resource_ProjectsIapWebServices extends Google_Service_Resource
{
  /**
   ...
   * access#managing_access_via_the_api (services.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which the policy is being
