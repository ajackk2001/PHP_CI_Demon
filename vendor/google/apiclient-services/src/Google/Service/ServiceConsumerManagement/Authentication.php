...
class Google_Service_ServiceConsumerManagement_Authentication extends Google_Collection
{
  protected $collection_key = 'rules';
  protected $providersType = 'Google_Service_ServiceConsumerManagement_AuthProvider';
  protected $providersDataType = 'array';
  protected $rulesType = 'Google_Service_ServiceConsumerManagement_AuthenticationRule';
