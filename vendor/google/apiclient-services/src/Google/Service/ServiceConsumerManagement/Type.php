...
class Google_Service_ServiceConsumerManagement_Type extends Google_Collection
{
  protected $collection_key = 'options';
  protected $fieldsType = 'Google_Service_ServiceConsumerManagement_Field';
  ...
  /**
   * @return Google_Service_ServiceConsumerManagement_Field
   */
