...
class Google_Service_ServiceConsumerManagement_Logging extends Google_Collection
{
  protected $collection_key = 'producerDestinations';
  protected $consumerDestinationsType = 'Google_Service_ServiceConsumerManagement_LoggingDestination';
  protected $consumerDestinationsDataType = 'array';
  protected $producerDestinationsType = 'Google_Service_ServiceConsumerManagement_LoggingDestination';
  ...
  /**
   * @return Google_Service_ServiceConsumerManagement_LoggingDestination
   */
