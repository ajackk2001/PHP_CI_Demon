...
class Google_Service_Compute_Resource_NodeTypes extends Google_Service_Resource
{
   ...
   * results.
   * @return Google_Service_Compute_NodeTypeAggregatedList
   */
  public function aggregatedList($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('aggregatedList', array($params), "Google_Service_Compute_NodeTypeAggregatedList");
  }
  /**
   ...
   */
  public function get($project, $zone, $nodeType, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone, 'nodeType' => $nodeType);
    $params = array_merge($params, $optParams);
   ...
   * the nextPageToken returned by a previous list request to get the next page of
   * results.
   * @return Google_Service_Compute_NodeTypeList
   */
  public function listNodeTypes($project, $zone, $optParams = array())
  {
    $params = array('project' => $project, 'zone' => $zone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Compute_NodeTypeList");
  }
}
