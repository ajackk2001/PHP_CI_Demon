...
class Google_Service_Compute_UsableSubnetwork extends Google_Collection
{
  protected $collection_key = 'secondaryIpRanges';
  public $ipCidrRange;
  public $network;
  protected $secondaryIpRangesType = 'Google_Service_Compute_UsableSubnetworkSecondaryRange';
