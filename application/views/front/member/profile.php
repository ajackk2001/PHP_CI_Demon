                ...
                <div class="TopBox col-12 col-md-3">
                    ...
                    <div class="UserInfo">
                        ...
                        <!-- <div class="toolbar">
                            ...
                            <button onclick="window.location.href='/member/chat'"><i class="fab fa-telegram-plane"></i><span>私訊</span></button>
                        </div> -->
                        <div class="model_des">
                            <p>
                        ...
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-tab" role="tablist">
                                ...
                                <li class="nav-item d-none">
                                    <a class="nav-link" id="custom-tabs-account-tab" data-toggle="pill" href="#custom-tabs-account" role="tab" aria-controls="custom-tabs-account" aria-selected="false">我的帳戶</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="card-body InfoBox">
                                    <div class="row">
                                        ...
                                        <?php if ($member->type!=1): ?>
                                            <div class="col-12 profile-field">
                                                <i class="fas fa-link"></i><span style="margin-left: 7px;">推薦連結網址</span>
                                                <div class="row">
                                                    <div id="link" class="copy-content col-12 col-sm-6"><?=$member_URL?></div>
                                                    <div class="col-12 col-sm-3">
                                                        <button data-clipboard-text="<?=$member_URL?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="已複製至剪貼簿" id="copyBtn" class="btn btn-send">複製連結</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 profile-field">
                                                <i class="fas fa-qrcode"></i><span style="margin-left: 7px;">推薦連結QRcode</span>
                                                <br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row gifts">
                        <div class="col-6 col-md-3">
                            ...
                            <label for="gift1" class="GiftBox">
                                ...
                                <div class="price">2500<span>(鑽石)</span></div>
                            </label>
                        </div>
                        <div class="col-6 col-md-3">
                            ...
                            <label for="gift2" class="GiftBox">
                                ...
                                <div class="price">10000<span>(鑽石)</span></div>
                            </label>
                        </div>
                        <div class="col-6 col-md-3">
                            ...
                            <label for="gift3" class="GiftBox">
                                ...
                                <div class="price">20000<span>(鑽石)</span></div>
                            </label>
                        </div>
                        <div class="col-6 col-md-3">
                            ...
                            <label for="gift4" class="GiftBox">
                                ...
                                <div class="price">50000<span>(鑽石)</span></div>
                            </label>
                        </div>
                    </div>
                    <form action="">
                    ...
                    <p class="pay">支付 2,500 鑽石</p>
                </div>
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-primary btn-block">確認送禮</button>
                </div>
            </div>
        </div>
    </div>
