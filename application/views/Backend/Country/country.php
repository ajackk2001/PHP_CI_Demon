    ...
    <body class="fixed-left popoverLg">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box" >
                                    <div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light add" data-toggle="modal" data-target=".modal_add">新增國籍</button>
                                    </div>
                                            ...
                                            <table id="tech-companies-1" class="table table-striped table-bordered data_list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="100" class="text-center" data-priority="1">國籍圖示</th>
                                                        <th width="250" class="text-center" data-priority="1">國籍名稱</th>
                                ...
                                <div class="modal-content">
                                    <form name="modal_add" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">新增國籍</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <fieldset class="form-group">
                                                        <label for="addTitle">國籍名稱<span class="text-danger">*</span></label>
                                                        <input type="text" name="title" class="form-control" id="addTitle" placeholder="國籍名稱" required>
                                                    </fieldset>
                                                </div>
                                                <div class="col-4">
                                                    <fieldset class="form-group">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form name="modal_edit" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">編輯國籍</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <fieldset class="form-group">
                                                        <label for="editTitle">國籍名稱<span class="text-danger">*</span></label>
                                                        <input type="text" name="title" class="form-control" id="editTitle" placeholder="國籍名稱" value="" required>
                                                    </fieldset>
                                                </div>
                                                <div class="col-4">
                                                    <fieldset class="form-group">
        ...
        <script>
            ...
            $(document).ready(() => {
                ...
                var json_ajax =   '/Backend/Country/Item';
                ...
                $(document).on('click','#updateSeq',function(){
                    var seq_ajax  =   '/Backend/Country/UpdateSeq';
                ...
                var status_ajx  =   '/Backend/Country/UpdateStatus/';
            ...
            <?php if(in_array(65, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
            $(document).on('click','.add',function(){
                $.post('/Backend/Country/LastSeq',{},(result)=>{
                    seq = parseInt(result)+1;
                    $('form[name=modal_add] input[name=seq]').val(seq);
                });
            });

            var add_ajax   =   '/Backend/Country/Add';
            ...
            var edit_ajax   =   '/Backend/Country/Edit/';
            ...
            $(document).on('click','.edit',function(){
                var info_ajax  =   '/Backend/Country/Info/';
                $.ajax({
            ...
            $(document).on('click','.delete',function(){
                var delete_ajax  =   '/Backend/Country/Delete/';
                var $this = $(this);
