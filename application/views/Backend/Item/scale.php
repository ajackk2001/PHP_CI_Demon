...
<html>
    ...
    <body class="fixed-left">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                	<div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light m-b-20 add" data-toggle="modal" data-target=".type_add">新增尺度分類</button>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="tech-companies-1" class="table table-striped table-bordered type_list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center" data-priority="1">尺度分類標題</th>
                                            ...
                                            <div class="modal-content">
                                                <form name="Type_add">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="mySmallModalLabel">新增尺度</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <label for="exampleInputEmail1">尺度分類標題<span class="text-danger">*</span></label>
                                                            <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="尺度分類標題" required>
                                                        </fieldset>
                                                        <fieldset class="form-group">
                                    ...
                                    <div class="modal fade bs-example-modal-sm type_edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form name="Type_edit">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="mySmallModalLabel">編輯尺度分類</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <label for="exampleInputEmail1">尺度分類標題</label>
                                                            <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="尺度分類標題">
                                                        </fieldset>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">關閉</button>
        ...
        <script type="text/javascript">
            var type_ajax =   '/Backend/ItemScale/Item';
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each(data.list,function(i,e){
                            ...
                            str +=(item_quantity==0)?'<td class="text-center"><input class="status" type="checkbox" '+((e.status==1)?'checked':'')+' data-id="'+e.id+'" data-plugin="switchery" data-color="#64b0f2" data-size="small"></td>':'<td class="text-center"><a href="javascript:;" data-toggle="tooltip" data-animation="false" data-placement="left" title="此商店分類已使用，不得下架">---</a></td>';
                            str +='<td class="text-center"><a href="javascript:void(0);" class="edit" data-id="'+e.id+'"><i class="zmdi zmdi-edit text-info"></i></a></td>';

                            str +=(item_quantity==0)?'<td class="text-center"><a href="javascript:;" data-id="'+e.id+'" class="delete-alert delete"><i class="zmdi zmdi-delete text-danger"></i></a></td>':'<td class="text-center"><a href="javascript:;" data-toggle="tooltip" data-animation="false" data-placement="left" title="此商店分類已使用，不得刪除">---</a></td>';
                            str +='</tr>';
                        });
            ...
            var type_add_ajax   =   '/Backend/ItemScale/Add';
            ...
            $(document).on('click','.add',function(){
                $.post('/Backend/ItemScale/LastSeq',{},(result)=>{
                    seq = parseInt(result)+1;
                    $('form[name=Type_add] input[name=seq]').val(seq);
                });
            });

            var type_edit_ajax   =   '/Backend/ItemScale/Edit/';
            ...
            $(document).on('click','.edit',function(){
                var type_info_ajax  =   '/Backend/ItemScale/Edit/';
                $.ajax({
            ...
            $(document).on('change','.status',function(){
                var type_edit_ajax2  =   '/Backend/ItemScale/Edit2/';
                $.ajax({
            ...
            $(document).on('click','.delete',function(){
                var type_delete_ajax  =   '/Backend/ItemScale/Delete/';
                var id 	=	$(this).data('id');
                swal({
                    title:'確定刪除?',
                    type:'warning',
            ...
            $('#updateOrder').click(function(){
                swal({
                    ...
                    if(result.value){
                        $.ajax({
                            url: '/Backend/ItemScale/updateSeq',
                            type:'POST',
                            dataType:'JSON',
