...
<html>
    ...
    <body class="fixed-left">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-4 col-xl-2">
                                                <select name="type" class="form-control" id="exampleSelect1">
                                                    <option value="">-收付款類型-</option>
                                                    <option value="1">現金付款</option>
                                                    <option value="2">朋有支付</option>
                                                    <option value="3">Punkcoco抵扣</option>
                                                    <option value="4">快速收款</option>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4 col-xl-2">
                                                <select name="status" class="form-control" id="exampleSelect1">
                                                    ...
                                                    <option value="2">交易失敗</option>
                                                    <option value="3">取消交易</option>
                                                    <option value="0">尚未結帳</option>
                                                    <option value="5">退貨完成</option>
                                                </select>
                                            </div>
                                            <div class="col-xs-12 col-md-8 col-xl-4">
                                                <input name="payment_sn" class="form-control m-b-20" type="text" placeholder="可搜尋：收付款編號">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12 col-md-8 col-xl-4">
                                                <input name="search" class="form-control m-b-20" type="text" placeholder="可搜尋會員資訊：帳號/姓名/手機">
                                            </div>
                                            <div class="col-xs-12 col-md-8 col-xl-4">
                                                <input name="search2" class="form-control m-b-20" type="text" placeholder="可搜尋廠商資訊：帳號/店家名稱/手機">
                                            </div>
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive">
                                            <table id="tech-companies-1" class="table table-striped table-bordered type_list">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center" data-priority="1">購買時間</th>
                                                        <th class="text-center" data-priority="1">購買會員帳號 / 名稱 / 暱稱</th>
                                                        <th class="text-center" data-priority="1">主/次分類</th>
                                                        <th class="text-center" data-priority="1">尺度分類</th>
                                                        <th class="text-center" data-priority="1" width="250">購買作品名稱</th>
        ...
        <script type="text/javascript">
            Page.row = 10;
            var type_ajax =   '/Backend/Item/Item/<?=$member_id?>';
