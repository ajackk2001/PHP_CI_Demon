...
<html>
    ...
    <body class="fixed-left">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <form name="search">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-4 col-xl-2 m-b-10">
                                                <select name="type" class="form-control" id="exampleSelect1">
                                                    <option value="">-所屬主分類-</option>
                                            ...
                                            <div class="col-xs-6 col-sm-3 col-md-2 col-xl-2 col-xl-2 m-b-10">
                                                <button type="button" id="btn_search" class="btn btn-block btn-primary waves-effect waves-light search">送出搜尋</button>
                                            </div>
                                            <div class="col-xs-6 col-sm-3 col-md-2 col-xl-2">
                                                <button type="button" id="btn_clear" class="btn btn-block btn-outline-secondary waves-effect reset">清空搜尋</button>
                                            </div>
                                        </div>
                                    </form>
                                	<div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light m-b-20" data-toggle="modal" data-target=".type_add">新增次分類</button>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="tech-companies-1" class="table table-striped table-bordered type_list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center" data-priority="1">所屬主分類</th>
                                                    <th class="text-center" data-priority="1">次分類標題</th>
                                                    <th class="text-center" data-priority="1">更新時間</th>
                                                    <th width="80" class="text-center" data-priority="1">作品數量</th>
                                                     <th width="80" class="text-center" data-priority="1">主題連結數量</th>
                                                    <th width="80" class="text-center" data-priority="1">熱門分類數量</th>
                                                    <!-- <th width="60" data-priority="1" class="text-center">編號<a id="updateOrder" data-toggle="tooltip" data-placement="top" title="" href="javascript:;" data-original-title="更新排序"><i class="ion-loop"></i></a></th> -->
                                            ...
                                            <div class="modal-content">
                                                <form name="Type_add">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="mySmallModalLabel">新增次分類</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <fieldset class="form-group">
                                                            <label for="exampleInputEmail1">所屬主分類<span class="text-danger">*</span></label>
                                                        ...
                                                        <fieldset class="form-group">
                                                            <label for="exampleInputEmail1">次分類標題<span class="text-danger">*</span></label>
                                                            <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="次分類標題">
                                                        </fieldset>
                                                        <fieldset class="form-group">
                                                            <label for="exampleInputEmail1">狀態<span class="text-danger">*</span></label>
                                    ...
                                    <div class="modal fade bs-example-modal-sm type_edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form name="Type_edit">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="mySmallModalLabel">編輯次分類</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <label for="exampleInputEmail1">所屬主分類<span class="text-danger">*<span id="error"><span></span></label>
                                                            <select class="form-control" name="type_id">
                                                                <option value="">請選擇</option>
                                                                <?php foreach ($type as $key => $value) : ?>
                                                                    <option value="<?=$value->id?>"><?=$value->title?></option>
        ...
        <script type="text/javascript">
            var type_ajax =   '/Backend/ItemCategory/Item';
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each(data.list,function(i,e){
                            ...
                            str +='<td class="text-center">'+(e.type_name==type?'-':e.type_name)+'</td>';
                            ...
                            <?php if(in_array(504, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
                            str +=(item_quantity==0&&theme_quantity==0&&popular_quantity==0)?'<td class="text-center"><input class="status" type="checkbox" '+((e.status==1)?'checked':'')+' data-id="'+e.id+'" data-plugin="switchery" data-color="#64b0f2" data-size="small"></td>':'<td class="text-center"><a href="javascript:;" data-toggle="tooltip" data-animation="false" data-placement="left" title="此分類已使用，不得下架">---</a></td>';
                            str +='<td class="text-center"><a href="javascript:void(0);" class="edit" data-id="'+e.id+'"><i class="zmdi zmdi-edit text-info"></i></a></td>';
                            <?php endif; ?>
                            <?php if(in_array(505, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
                            str +=(item_quantity==0&&theme_quantity==0&&popular_quantity==0)?'<td class="text-center"><a href="javascript:;" data-id="'+e.id+'" class="delete-alert delete"><i class="zmdi zmdi-delete text-danger"></i></a></td>':'<td class="text-center"><a href="javascript:;" data-toggle="tooltip" data-animation="false" data-placement="left" title="此分類已使用，不得刪除">---</a></td>';
                            <?php endif; ?>
                            str +='</tr>';
                            type=e.type_name;
                        });
            ...
            Table.LoadTable();
            <?php if(in_array(503, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
            var type_add_ajax   =   '/Backend/ItemCategory/Add';
            ...
            <?php endif; ?>
            <?php if(in_array(504, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
            var type_edit_ajax   =   '/Backend/ItemCategory/Edit/';
            var type_edit_ajax2   =   '/Backend/ItemCategory/Edit2/';
            ...
            $(document).on('click','.edit',function(){
                var type_info_ajax  =   '/Backend/ItemCategory/Edit/';
                $.ajax({
                    ...
                    success:function(data){
                        $.each(data,function(key,value){
                            data.shop_quantity=0;
                            $('form[name=Type_edit] input[name='+key+']').val(value);
                            $('form[name=Type_edit] select[name='+key+']').val(value);
                            if(data.shop_quantity!=0){
                                $('#error').html(' 此商店類型已使用，不可變動分類。');
                                $('form[name=Type_edit] select[name=store_type_id]').attr("disabled","disabled");
                            }else{
                                $('#error').html('');
                                $('form[name=Type_edit] select[name=store_type_id]').removeAttr("disabled");
                            }
                        });
            ...
            $(document).on('click','.delete',function(){
                var type_delete_ajax  =   '/Backend/ItemCategory/Delete/';
                var id 	=	$(this).data('id');
                swal({
                    title:'確定刪除?',
                    type:'warning',
            ...
            $('#updateOrder').click(function(){
                swal({
                    ...
                    if(result.value){
                        $.ajax({
                            url: '/Backend/ItemCategory/updateSeq',
                            type:'POST',
                            dataType:'JSON',
