    ...
    <body class="fixed-left popoverLg">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box" >
                                    <div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light add" data-toggle="modal" data-target=".modal_add">新增熱門分類</button>
                                    </div>
                                            ...
                                            <table id="tech-companies-1" class="table table-striped table-bordered data_list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="120" class="text-center" data-priority="1">主分類</th>
                                                        <th width="120" class="text-center" data-priority="1">次分類</th>
                                ...
                                <div class="modal-content">
                                    <form name="modal_add" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">新增熱門分類</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <fieldset class="form-group">
                                                        <label for="addTitle">作品主分類<span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-12">
                                                    <fieldset class="form-group">
                                                        <label for="addTitle">作品次分類<span class="text-danger">*</span></label>
                                                        <select name="category_id" id="" class="form-control category" required >
                                                            <option value="" data-type_id="">請選擇次分類</option>
                                                        </select>
                                                        <select name="" id="category_id" class="form-control d-none">
                                                            <option value="" data-type_id="0">請選擇次分類</option>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form name="modal_edit" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">編輯熱門分類</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
        ...
        <script>
            ...
            $(document).ready(() => {
                ...
                var json_ajax =   '/Backend/Popular/List';
                        ...
                        waitingDialog.hide();
                            ...
                            $.each(data.list,function(i,e){
                                str +=` <tr>
                                            ...
                                            <td class="vertical-align-middle text-center">${e.type_title}</td>
                                            <td class="vertical-align-middle text-center">${e.category_title||'---'}</td>
                ...
                $(document).on('click','#updateSeq',function(){
                    var seq_ajax  =   '/Backend/Popular/UpdateSeq';
                ...
                var status_ajx  =   '/Backend/Popular/UpdateStatus/';
            ...
            $(document).on('click','.add',function(){
                $.post('/Backend/Popular/LastSeq',{},(result)=>{
                    seq = parseInt(result)+1;
                    $('form[name=modal_add] input[name=seq]').val(seq);
                });
            });

            var add_ajax   =   '/Backend/Popular/Add';
            ...
            var edit_ajax   =   '/Backend/Popular/Edit/';
            ...
            $(document).on('click','.edit',function(){
                var info_ajax  =   '/Backend/Popular/Info/';
                $.ajax({
            ...
            $(document).on('click','.delete',function(){
                var delete_ajax  =   '/Backend/Popular/Delete/';
                var $this = $(this);
