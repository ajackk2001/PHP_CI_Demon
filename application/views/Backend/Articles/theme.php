    ...
    <body class="fixed-left popoverLg">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box" >
                                    <div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light add" >新增主題連結</button>
                                    </div>
                                ...
                                <div class="modal-content">
                                    <form name="modal_add" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">新增主題連結</h5>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form name="modal_edit" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">編輯主題連結</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
        ...
        <script>
            ...
            $(document).ready(() => {
                ...
                var json_ajax =   '/Backend/Theme/List';
                ...
                $(document).on('click','#updateSeq',function(){
                    var seq_ajax  =   '/Backend/Theme/UpdateSeq';
                ...
                var status_ajx  =   '/Backend/Theme/UpdateStatus/';
            ...
            $(document).on('click','.add',function(){
                if(num<5){
                    $.post('/Backend/Theme/LastSeq',{},(result)=>{
            ...
            var add_ajax   =   '/Backend/Theme/Add';
            ...
            var edit_ajax   =   '/Backend/Theme/Edit/';
            ...
            $(document).on('click','.edit',function(){
                var info_ajax  =   '/Backend/Theme/Info/';
                $.ajax({
            ...
            $(document).on('click','.delete',function(){
                var delete_ajax  =   '/Backend/Theme/Delete/';
                var $this = $(this);
