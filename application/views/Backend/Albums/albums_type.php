...
<html>
    ...
    <body class="fixed-left popoverLg">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box" >
                                <?php if(in_array(56, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
                                    <div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light add" data-toggle="modal" data-target=".modal_add">新增花絮分類</button>
                                    </div>
                                <?php endif; ?>
                                            ...
                                            <table id="tech-companies-1" class="table table-striped table-bordered data_list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php if(in_array(57, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
                                ...
                                <div class="modal-content">
                                    <form name="modal_add" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">新增花絮分類</h5>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form name="modal_edit" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">編輯花絮分類</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
        ...
        <script>
            $(document).ready(() => {
                var json_ajax =   '/Backend/AlbumsType/List';
                ...
                $(document).on('click','#updateSeq',function(){
                    var seq_ajax  =   '/Backend/Albums/UpdateSeq/type';
                ...
                var status_ajx  =   '/Backend/Albums/UpdateStatus/type/';
            ...
            $(document).on('click','.add',function(){
                $.post('/Backend/Albums/LastSeq/type',{},(result)=>{
                    seq = parseInt(result)+1;
                    $('form[name=modal_add] input[name=seq]').val(seq);
                });
            });

            var add_ajax   =   '/Backend/AlbumsType/Add';
            ...
            <?php endif; ?>
            <?php if(in_array(57, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
            var edit_ajax   =   '/Backend/AlbumsType/Edit/';
            ...
            $(document).on('click','.edit',function(){
                var info_ajax  =   '/Backend/AlbumsType/Info/';
                $.ajax({
            ...
            $(document).on('click','.delete',function(){
                var delete_ajax  =   '/Backend/AlbumsType/Delete/';
                var $this = $(this);
