...
<html>
    ...
    <body class="fixed-left">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <form name="search">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-8 col-xl-4">
                                                <input name="search" class="form-control m-b-20" type="text" placeholder="可搜尋會員資訊：會員姓名/暱稱/Email" value="<?=$name?>">
                                            </div>
                                            <div class="col-xs-12 col-md-8 col-xl-4">
                                                <input name="search2" class="form-control m-b-20" type="text" placeholder="可搜尋：付款編號">
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light" onClick="location.href='<?=site_url('/Backend/Points/Add');?>'">新增</button>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="tech-companies-1" class="table table-striped table-bordered member_list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="100" class="text-center" data-priority="1">動作</th>
                                                    <th width="200" class="text-center" data-priority="1">付款編號</th>
                                                    <th width="80" class="text-center" data-priority="1">項目</th>
                                                    <th width="100" class="text-center" data-priority="1">點數</th>
                                                    <th width="100" class="text-center" data-priority="1">結餘總額</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
        ...
        <script type="text/javascript">
            ...
            var type        =   {1:'購買',2:'扣除',3:'轉入',4:'轉出',5:'兌現',6:'扣除',7:'贈送'};
            var type_css    =   {1:'text-info',2:'text-danger',3:'text-info',4:'text-danger',5:'text-danger',6:'text-danger',7:'text-info'};
            var member_ajax =   '/Backend/Points';
                        ...
                        $.each(data.list,function(i,e){
                            str+=`
                                 <tr>
                                    ...
                                    <td width="200" class="text-center" data-priority="1">${((e.payment_sn)?e.payment_sn:'---')}</td>
                                    <td width="80" class="text-center" data-priority="1">
                                        <i data-toggle="tooltip" data-placement="top" data-original-title="${e.remark}" class="ion-android-note"></i>
                                    </td>
                                    <td width="100" class="text-center" data-priority="1"><span class="${type_css[e.type]}">${e.points}</span></td>
                                    <td width="100" class="text-center" data-priority="1"><span class="text-success">${data.pointsTotal[e.member_id][e.id]}</span></td>
                                </tr>
                            `;
                        });
