    ...
    <body class="fixed-left">
                                ...
                                <div class="card-box">
                                	<form name="send">
		                                ...
		                                <fieldset class="form-group col-xs-4">
		                                    <label for="exampleSelect1">郵件格式</label> <a data-toggle="tooltip" data-html="true" data-placement="top" title="" href="javascript:;" data-original-title="1.如無選擇格式，請自行輸入郵件內容。<br/>2.如無相關郵件格式，可自行至郵件格式新增。"><i class="ion-information-circled"></i></a>
		                                    <select class="form-control" id="format_type" data-parsley-id="41">
		                                        <option value="">--- 選擇郵件格式 ---</option>
												<?php
		                                ...
		                                <fieldset class="form-group col-xs-12 col-md-12 col-lg-12 col-xl-6" required="">
		                                    ...
		                                    <textarea class="form-control" id="content" rows="5" data-parsley-id="45"></textarea>
		                                    <div class="font-13 m-t-1">您目前的字數為<span id="text_num">0</span>字，將以<span id="message_num">1</span>封郵件發送。</div>
		                                </fieldset>
		                                <div class="center">
        ...
        <script type="text/javascript">
        	...
        	CKEDITOR.instances["content"].on("instanceReady", function () {  
			    //set keyup event  
			    this.document.on("keyup", calculate);  
			});  
			function calculate(){
				$('#text_num').text(CKEDITOR.instances.content.document.getBody().getText().length);
			}
        	...
        	$('#format_type').change(function(){
        		...
        		CKEDITOR.instances.content.setData(settings[$(this).val()].content);
        	});
        	var mail_send_ajax	=	'/Backend/Mail/Send';
