    ...
    <body class="fixed-left popoverLg">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php if(in_array(65, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
                                    <div class="clearfix">
                                        <button type="button" class="btn btn-custom waves-effect waves-light add" data-toggle="modal" data-target=".modal_add">新增輪播圖</button>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="modal-content">
                                    <form name="modal_add" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">新增輪播圖</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="url" name="weblink" class="form-control" placeholder="">
                                                    </fieldset>
                                                </div>
                                                <div class="col-12">
                                                    <fieldset class="form-group">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form name="modal_edit" enctype="multipart/form-data" >
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mySmallModalLabel">編輯輪播圖</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
        ...
        <script>
            ...
            $(document).ready(() => {
                ...
                var json_ajax =   '/Backend/Banner/List';
                ...
                $(document).on('click','#updateSeq',function(){
                    var seq_ajax  =   '/Backend/Banner/UpdateSeq';
                ...
                var status_ajx  =   '/Backend/Banner/UpdateStatus/';
            ...
            $(document).on('click','.add',function(){
                $.post('/Backend/Banner/LastSeq',{},(result)=>{
                    seq = parseInt(result)+1;
                    $('form[name=modal_add] input[name=seq]').val(seq);
                });
            });

            var add_ajax   =   '/Backend/Banner/Add';
            ...
            <?php endif; ?>
            <?php if(in_array(66, $this->session->userdata('Manager')->menu_permission)||$this->issuper): ?>
            var edit_ajax   =   '/Backend/Banner/Edit/';
            ...
            $(document).on('click','.edit',function(){
                var info_ajax  =   '/Backend/Banner/Info/';
                $.ajax({
            ...
            $(document).on('click','.delete',function(){
                var delete_ajax  =   '/Backend/Banner/Delete/';
                var $this = $(this);
