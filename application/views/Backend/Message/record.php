...
<html>
    ...
    <body class="fixed-left">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="card-box tilebox-one">
                                    ...
                                    <h6 class="text-muted text-uppercase m-b-20">剩餘簡訊點數</h6>
                                    <h2 class="m-b-20">$<span id="point">0</span></h2>
                                    <div class="d-none" id="notice">
                                        <span class="label label-danger ">注意!!</span><span class="text-muted text-danger">您目前已無簡訊點數!! 若需增加簡訊點數，請與管理者連繫</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-box">
                                	<div class="table-rep-plugin">
                                        <div class="table-responsive">
                                            <table id="tech-companies-1" class="table table-striped table-bordered message_record_list">
                                                <thead>
                                                <tr>
                                                    <th width="50" class="text-center" data-priority="1">發送序號</th>
                                                    <th width="200" class="text-center" data-priority="1">會員/電話</th>
        ...
        <script type="text/javascript">
            var message_record_ajax =   '/Backend/Message/Record';
            Table.DrawTable =   function(){
                $.ajax({
                    url:message_record_ajax,
                    type:'POST',
                    dataType:'JSON',
                    ...
                    waitingDialog.hide();
                        ...
                        $.each(data.list,function(i,e){
                            ...
                            str +='<td class="text-center">'+e.name+'/'+e.cellphone+'</td>';
                        ...
                        $('.message_record_list>tbody').html(str);
